...
It'd be pretty devastating if I set all this up and a data structure was wrong and wasn't representative of the visual board state. Hence I wrote another window to display bitboards of pieces, this will be very useful when I begin moving pieces. The long-term aim will be for the this to update in real-time alongside the main window.
