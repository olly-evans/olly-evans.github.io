...
The dream thing was actually a load of bullshit, I saw it in a Youtube video and thought it was pretty smart so I implemented it before moving forward. Because who doesn't like efficiency.

### Optimization: Rendering Only Upon Mouseclicks

Long story short we can save ourselves a lot of CPU usage by just not re-rendering our main window until a mouse event happens. More on this when I get to it.
